    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 px-4">
            <div class="bg-white p-6 rounded-2xl shadow-lg">
                <form method="POST" action="{{ route('admin.bank.update', $bank) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" value="{{$bank->name}}" name="name" type="text" class="mt-1 block w-full" required autofocus />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="description" value="{{$bank->description}}" name="description" type="text" class="mt-1 block w-full" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="operation_hours" value="{{$bank->operation_hours}}" name="operation_hours" type="text" class="mt-1 block w-full" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="address" name="address" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>{{$bank->address}}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="maps_embed" name="maps_embed" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{$bank->maps_embed}}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="contact_person" value="{{$bank->contact_person}}" name="contact_person" type="text" class="mt-1 block w-full" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="phone_number" value="{{$bank->phone_number}}" name="phone_number" type="text" class="mt-1 block w-full" />
                    ...
                    <div class="mb-4">
                        ...
                        {{-- Preview Image --}}
                        <div class="mt-4">
                            <img id="preview" src="{{asset('storage/' . $bank->image_url)}}" alt="{{$bank->name}}" class="w-10 h-10 object-cover rounded shadow" />
                        </div>
