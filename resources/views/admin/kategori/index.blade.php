                        ...
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left font-medium text-gray-600">Poin/Kg</th>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr>
                                    <td class="px-4 py-2">{{ $kategoriSampah->firstItem() + $index }}</td>
                                    <td class="px-4 py-2">{{ $kategori->name }}</td>
                                    <td class="px-4 py-2">{{ $kategori->description }}</td>
                                    <td class="px-4 py-2">{{ $kategori->points_per_kg }} poin</td>
                                    <td class="px-4 py-2 text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{route('admin.kategori.edit', $kategori)}}" title="Edit"
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-gray-500">Kategori sampah tidak ditemukan.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
