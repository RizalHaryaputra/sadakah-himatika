            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg">
                <form method="POST" action="{{route('admin.kategori.update', $kategori)}}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" value="{{$kategori->name}}" name="name" type="text"
                    ...
                    <x-text-input id="price_per_kg" value="{{$kategori->price_per_kg}}" name="price_per_kg"
                        type="hidden" step="0.01" class="mt-1 block w-full" />
                    <x-input-error :messages="$errors->get('price_per_kg')" class="mt-2" />
                    
                    <!-- Points per kg -->
                    <div class="mb-4">
                        <x-input-label for="points_per_kg" :value="__('Poin per Kg')" />
                        <x-text-input id="points_per_kg" value="{{$kategori->points_per_kg}}" name="points_per_kg"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{$kategori->description}}</textarea>
