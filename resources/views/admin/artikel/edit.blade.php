            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg">
                ...
                <form method="POST" action="{{route('admin.artikel.update', $artikel)}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="title" value="{{$artikel->title}}" name="title" type="text"
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="author_name" value="{{$artikel->author_name}}" name="author_name" type="text"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="excerpt" name="excerpt" rows="3"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{$artikel->excerpt}}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="content" name="content" rows="6"
                            ...
                            required>{{$artikel->content}}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="published_at" value="{{$artikel->published_at}}" name="published_at"
                    ...
                    <div class="mb-4">
                        ...
                        {{-- Preview Image --}}
                        <div class="mt-4">
                            <img id="preview" src="{{asset('storage/' . $artikel->image_url)}}" alt="{{$artikel->title}}" class="w-10 h-10 object-cover rounded shadow" />
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="is_active" name="is_active"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="1" {{ $artikel->is_active ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ !$artikel->is_active ? 'selected' : '' }}>Nonaktif</option>
                        </select>
