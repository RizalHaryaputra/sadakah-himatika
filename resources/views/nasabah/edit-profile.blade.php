    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 px-4">
            <div class="bg-white p-6 rounded-2xl shadow-lg">
                ...
                @endif
                <form method="POST" action="{{route('nasabah.update-profile', $pengguna)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                    ...
                    <input name="role" type="hidden" value="Nasabah" />
                    ...
                    <div class="mb-4">
                        ...
                        <select id="padukuhan_id" name="padukuhan_id"
                            ...
                            <option value="{{ $id }}" {{ old('padukuhan_id', $pengguna->padukuhan_id) == $id ?
                                'selected' :
                                '' }}>
                                {{ $nama }}
                            </option>
                    ...
                    <div class="mb-4">
                        ...
                        {{-- Preview Image --}}
                        <div class="mt-4">
                            <img id="preview" src="{{asset('storage/' . $pengguna->profile_picture)}}"
                                alt="{{$pengguna->name}}" class="w-10 h-10 object-cover rounded shadow" />
                        </div>
