    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                @hasanyrole('Super Admin|Operator Padukuhan')
                ...
                @role('Super Admin')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.hadiah.index')" :active="request()->routeIs('admin.hadiah.index')">
                        {{ __('Hadiah') }}
                    </x-nav-link>
                </div>
                @endrole
                ...
                @hasanyrole('Super Admin|Operator Padukuhan')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.setoran.index')" :active="request()->routeIs('admin.setoran.index')">
                        {{ __('Transaksi') }}
                    </x-nav-link>
                </div>
                @endhasanyrole
